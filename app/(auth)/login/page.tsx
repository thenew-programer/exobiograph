    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-3 text-center">
          ...
          <CardTitle className="text-2xl">Welcome to ExoBioGraph</CardTitle>
          <CardDescription>
            Sign in to explore space biology research with AI
          </CardDescription>
        </CardHeader>
        <CardContent>
          <LoginForm />
          <div className="mt-4 text-center text-sm text-slate-600 dark:text-slate-400">
            ...
            <Link href="/signup" className="text-[#2a5298] hover:underline font-medium">
              Sign up
            </Link>
          </div>
